...
export type GrowthChannel = 'seo' | 'social' | 'producthunt' | 'community' | 'ads' | 'content' | 'other';
export type TechStack = 'Vue' | 'React' | 'Nuxt' | 'Next' | 'Tailwind CSS' | 'Supabase' | 'Firebase' | 'Node' | 'Python' | 'Go' | 'PHP' | 'Laravel' | 'Rails' | 'other';
